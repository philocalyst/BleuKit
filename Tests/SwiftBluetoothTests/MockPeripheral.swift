...
private class ConnectablePeripheralDelegateSpec: CBMPeripheralSpecDelegate {
  ...
  func peripheral(
    _ peripheral: CBMPeripheralSpec, didReceiveReadRequestFor characteristic: CBMCharacteristicMock
  ) -> Result<Data, Error> {
  ...
  func peripheral(
    ...
    didReceiveWriteCommandFor characteristic: CBMCharacteristicMock, data: Data
  ) {
  ...
  func peripheral(
    _ peripheral: CBMPeripheralSpec,
    didReceiveWriteRequestFor characteristic: CBMCharacteristicMock, data: Data
  ) -> Result<Void, Error> {
    values[characteristic.uuid] = data
  ...
  func peripheral(
    _ peripheral: CBMPeripheralSpec, didReceiveSetNotifyRequest enabled: Bool,
...
let mockCharacteristics: [CBMCharacteristicMock] = [
  .init(
    type: CBMUUID(string: "00000000-0000-0000-0001-000000000001"),
    properties: [.write, .writeWithoutResponse, .read, .notify],
    descriptors: CBMClientCharacteristicConfigurationDescriptorMock()),
  .init(
    type: CBMUUID(string: "00000000-0000-0000-0001-000000000002"),
    properties: [.write, .read],
    descriptors: CBMClientCharacteristicConfigurationDescriptorMock()),
  .init(
    type: CBMUUID(string: "00000000-0000-0000-0002-000000000001"),
    properties: [.write],
    descriptors: CBMClientCharacteristicConfigurationDescriptorMock()),
  .init(
    type: CBMUUID(string: "00000000-0000-0000-0002-000000000002"),
    properties: [.read],
    descriptors: CBMClientCharacteristicConfigurationDescriptorMock()),
]
...
let mockServices: [CBMServiceMock] = [
  .init(
    type: CBMUUID(string: "00000000-0000-0000-0001-000000000000"),
    primary: true,
    characteristics: mockCharacteristics[0], mockCharacteristics[1]),
  .init(
    type: CBMUUID(string: "00000000-0000-0000-0002-000000000000"),
    primary: true,
...
.advertising(
  advertisementData: [
    CBMAdvertisementDataLocalNameKey: "Test Device",
