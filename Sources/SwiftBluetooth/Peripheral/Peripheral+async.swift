...
extension Peripheral {
  ...
  @available(iOS 13, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
  public func discoverCharacteristics(_ characteristics: [Characteristic], for service: CBService)
    async throws -> [CBCharacteristic]
  {
    try await withCheckedThrowingContinuation { cont in
  ...
  @available(iOS 13, macOS 10.15, watchOS 6.0, tvOS 13.0, *)
  @discardableResult
  public func setNotifyValue(_ value: Bool, for characteristic: CBCharacteristic) async throws
    -> Bool
  {
    try await withCheckedThrowingContinuation { cont in
